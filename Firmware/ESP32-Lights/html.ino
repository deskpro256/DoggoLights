...
char HTML2[] PROGMEM = "%</p>\n"
                       ...
                       "         <p>Change the device name and password. This will restart the device. You'll need to connect again using the new\n"
                       "            credentials.\n"
                       "         </p>\n"
                       "         <form action=\"/get\">\n"
...
char HTML3[] PROGMEM = "\" required />\n"
                       ...
                       "            <input type=\"checkbox\" onclick=\"showPassword(1)\" /> Show\n"
                       "            <br />\n"
                       "            <input type=\"password\" name=\"password\" id=\"passInput1\" placeholder=\"Password\" required />\n"
                       "            <br />\n"
                       "            <br />\n"
                       ...
                       "         <br/>\n"
                       "         <br/>\n"
                       "         <p>Firmware version: v";
// split here
//1.0.2
//currentFirmwareVersion
char HTML4[] PROGMEM = " </p>\n"
                       "         <br/>\n"
                       "         <p>Input your home network name and password if you want to check for firmware updates.</p>\n"
                       "         <p>The device will try to connect to your home network, check for a new FW version and update if necessary.</p>\n"
                       "         <br/>\n"
                       "         <input type=\"checkbox\" id=\"showWifiCheckbox\" onclick=\"showHomeWifiForm()\" /> Change home WiFi credentials.\n"
                       "         <br/>\n"
                       "         <br/>\n"
                       "         <div id=\"homeSsidDiv\" style=\"display: none;\">\n"
                       "            <form action=\"/get\">\n"
                       "               <label for=\"homeSsid\">Home network name: </label>\n"
                       "               <br />\n"
                       "               <input type=\"text\" name=\"homeSsid\" placeholder=\"";
//homeSsid
char HTML5[] PROGMEM = "\" required />\n"
                       "               <br />\n"
                       "               <br />\n"
                       "               <label for=\"homePassword\">Password: </label>\n"
                       "               <input type=\"checkbox\" onclick=\"showPassword(2)\" /> Show\n"
                       "               <br />\n"
                       "               <input type=\"password\" name=\"homePassword\" id=\"passInput2\" placeholder=\"Password\" required />\n"
                       "               <br />\n"
                       "               <br />\n"
                       "               <input type=\"submit\" value=\"Save\" />\n"
                       "            </form>\n"
                       ...
                       "         <br />\n";
//update button div
char HTML6[] PROGMEM = "         <form action=\"/get\">\n"
                       "            <input type=\"submit\" value=\"Update\" name=\"update\"/>\n"
                       "         </form>\n";
char HTML7[] PROGMEM = "</div>\n"
                       "      <script>\n"
                       ...
                       "         }\n"
                       "         }\n"
                       "         function showHomeWifiForm(){\n"
                       "         var x = document.getElementById(\"homeSsidDiv\");\n"
                       "         var checkbox = document.getElementById(\"showWifiCheckbox\");\n"
                       "         if (checkbox.checked) {\n"
